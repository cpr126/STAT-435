...
In this case, I would expect the inflexible method to perform better. Since the 

The risk of over-fitting is very high and any patterns picked up by flexible methods are more likely to be mere noise. Therefore an inflexible method should be preferred.
